## There all type of tailwindcss template use with React and also all Animation uses with pure javascript.There is different component for different template.
